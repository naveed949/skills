...
- **`to-spec`** now orders Implementation Decisions volatile-first: data models, then interfaces and contracts, then user-facing choices, with mechanical refactoring last.
